...
const GenerateImages = () => {
  ...
  // ✅ Improved download function that triggers actual browser download
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      {/* Right col */}
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 relative'>
        <div className='flex items-center justify-between'>
          ...
          {content && (
            <button
              ...
              className='flex items-center gap-1 text-sm text-white bg-green-500 hover:bg-green-600 px-3 py-1.5 rounded-md'
            >
